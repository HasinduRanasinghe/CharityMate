...
import com.example.charitymate.databinding.ActivityAddMicrofinanceDonationBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import com.google.firebase.storage.StorageReference

class AddMfDonations : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddMicrofinanceDonationBinding.inflate(layoutInflater)
            ...
            storageRef.putFile(it).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    storageRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        firebaseFirestore.collection("MicrofinanceDetails").add(map)
