...
import com.example.charitymate.databinding.ActivityAddHealthDonationsBinding
...
class AddHealthDonations : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddHealthDonationsBinding.inflate(layoutInflater)
    ...
    private fun initVars() {
        storageRef = FirebaseStorage.getInstance().reference.child("HealthDetails")
            ...
            storageRef.putFile(it).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    storageRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        val location = binding.healthLocation.text.toString().trim()
                        ...
                        firebaseFirestore.collection("HealthDetails").add(map)
